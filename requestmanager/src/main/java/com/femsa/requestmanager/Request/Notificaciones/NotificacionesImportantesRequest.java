...
public class NotificacionesImportantesRequest implements Callback<ResponseBody> {

    private MarcarNotificacionesResponseContract mListener;

    private Context mContext;

    public static final String ID_NOTIFICACION_KEY = "idNotificacion";

    public NotificacionesImportantesRequest(Context context)
    {
        mContext = context;
    }

    public interface MarcarNotificacionesResponseContract extends ResponseContract
    {
        /**
        ...
        /**
         * Llamado cuando se marca una notificación como importante
         * */

        void OnNotificacionMarcada();
    ...
    public void makeRequest(String token, int idNotificacion, MarcarNotificacionesResponseContract listener)
    {
        mListener = listener;
        if (Utilities.getConnectivityStatus(mContext))
        {
            ...
            request = delNotificaciones.requestNotificacionImportante(crearParametros(idNotificacion), token);
    ...
    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
        ...
        switch (response.code())
        {
            case RequestManager.CODIGO_SERVIDOR.OK:
                mListener.OnNotificacionMarcada();
                break;

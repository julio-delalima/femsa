...
public class EliminarNotificacionesRequest  implements Callback<ResponseBody> {

    private EliminarNotificacionesResponseContract mListener;

    private Context mContext;

    public static final String ID_NOTIFICACION_KEY = "idNotificacion";

    public EliminarNotificacionesRequest(Context context)
    {
        mContext = context;
    }

    public interface EliminarNotificacionesResponseContract extends ResponseContract
    {
        /**
        ...
        /**
         * Llamado cuando se elimina una notificación
         * */

        void OnNotificacionEliminada();
    ...
    public void makeRequest(String token, int idNotificacion, EliminarNotificacionesResponseContract listener)
    {
        mListener = listener;
        if (Utilities.getConnectivityStatus(mContext))
        {
            ...
            request = delNotificaciones.requestBorrarNotificacion(crearParametros(idNotificacion), token);
    ...
    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
        ...
        switch (response.code())
        {
            case RequestManager.CODIGO_SERVIDOR.OK:
                mListener.OnNotificacionEliminada();
                break;

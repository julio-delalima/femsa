...
public class SubcategoriesParser extends Parser<SubcategoriesResponse> {

        private int mErrorCode;

        public SubcategoriesParser(int errorCode)
        {
            mErrorCode = errorCode;
        }

        @Override
        protected Response<SubcategoriesResponse> doInBackground(String... json) {
            ...
            Response<SubcategoriesResponse> data = new Response<>();
            ...
            {
                data.setData(new SubcategoriesResponse(nodoPrincipal.optJSONObject(Response.DATA_KEY)));
            }

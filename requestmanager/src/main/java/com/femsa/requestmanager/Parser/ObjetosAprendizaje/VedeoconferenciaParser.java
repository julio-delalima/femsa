...
public class VedeoconferenciaParser extends Parser<VedeoconferenciaResponseData> {

    private int mErrorCode;

    public VedeoconferenciaParser(int errorCode)
    {
        mErrorCode = errorCode;
    }

    @Override
    protected Response<VedeoconferenciaResponseData> doInBackground(String... json) {
        ...
        Response<VedeoconferenciaResponseData> data = new Response<>();
        ...
        {
            try {
                data.setData(new VedeoconferenciaResponseData(nodoPrincipal.optJSONObject(Response.DATA_KEY)));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }

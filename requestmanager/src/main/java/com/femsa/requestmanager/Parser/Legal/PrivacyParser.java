...
public class PrivacyParser extends Parser<PrivacyAdviceResponseData> {

    private int mErrorCode;

    public PrivacyParser(int errorCode)
    {
        mErrorCode = errorCode;
    }

    @Override
    protected Response<PrivacyAdviceResponseData> doInBackground(String... json) {
        ...
        Response<PrivacyAdviceResponseData> data = new Response<>();
        ...
        {
            data.setData(new PrivacyAdviceResponseData(nodoPrincipal.optJSONObject(Response.DATA_KEY)));
        }

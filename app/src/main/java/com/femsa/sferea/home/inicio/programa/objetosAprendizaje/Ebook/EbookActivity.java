...
public class EbookActivity extends AppCompatActivity implements LearningObjectView, DescargaArchivoAsync.OnStatusDescarga, InsertObjetoAsyncTask.OnBDStatus {

        private ImageView beginButton, mDownloadButton;

        private ImageView mEbookView;
        ...
        private String mPDFPath, mPDFFilename, mImageName, mFullPath, mRutaArchivo, mRutaImagen;

        private ConstraintLayout mEbookRootView;
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.ebook_viewer);
            bindData();
            bindViews();
        }
        ...
        private void bindViews(){
            ...
            mEbookRootView = findViewById(R.id.ebook_root_view);
               mEbookRootView.setVisibility(View.INVISIBLE);


            mEbookView = findViewById(R.id.fullebookView);
            mDownloadButton = findViewById(R.id.ebook_download_button);
                mDownloadButton.setOnClickListener(v -> descargarObjeto());

            ConstraintLayout allContainer = findViewById(R.id.ebook_constraint);
            ...
            beginButton = findViewById(R.id.ebook_begin_button);
                beginButton.setOnClickListener(v -> onBeginPressed());

            description = findViewById(R.id.ebook_description);

            mTitle = findViewById(R.id.ebook_title_tv);

            mEstimatedTime = findViewById(R.id.ebook_stimated_time_tv);

            mCorcholatas = findViewById(R.id.ebook_corcholata_counter);

            mLike = findViewById(R.id.ebook_like_iv);
            mLike.setOnClickListener(v -> OnLikePressed());
        }

    private void configuraOffline(){
        mEbookRootView.setVisibility(View.VISIBLE);
        ...
        description.loadDataWithBaseURL(null, text, "text/html", "utf-8", null);
        ...
        {
            if(mIsOfflineFile){
                Intent sendTo = new Intent(this, FullEbookActivity.class);
                ...
                Intent sendTo = new Intent(this, FullEbookActivity.class);
                sendTo.putExtra(RequestManager.ARCHIVO_URL_KEY, mFullPath);
